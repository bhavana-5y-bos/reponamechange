    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.indexOf("success") > -1) {
                ...
                var selectedRow = $("#tableUsers tr[id='" + data.UserId + "']")[0].children[5]; 
    ...
    if (roleName === null || roleName === "") {
        ...
        if (pattern.test(roleName)) {
            ...
            var role = {
                ...
                "IsSuperAdmin": $("#addRoleIsSuperAdmin")[0].checked,
                "IsAdmin": $("#addRoleIsAdmin")[0].checked
            };
    ...
    if (roleName === null || roleName === "") {
        ...
        if (pattern.test(roleName)) {
            ...
            var role = {
                ...
                "IsSuperAdmin": $("#editRoleIsSuperAdmin")[0].checked,
                "IsAdmin": $("#editRoleIsAdmin")[0].checked,
...
function OnPermissionsSave() {
    ...
    Array.prototype.forEach.call(modulesList, module => {
        if (module.getAttribute('parentmoduleid') !== null) {
        ...
        permissionSet.ModuleId = module.id;
        permissionSet.Name = module.name;
        permissionSet.Code = module.getAttribute('code');
        permissionSet.ParentModuleId = module.getAttribute('parentmoduleid');
    ...
    Array.prototype.forEach.call(operationsList, operation => {
        if (operation.getAttribute('parentoperationid') !== null) {
            const found = updatedModulesList.some(el => el.OperationId === module.getAttribute('parentoperationid'));
            if (!found) {
                if (operations === "") {
        ...
        permissionsOperation.ModuleId = operation.getAttribute('moduleid');
        ...
        permissionsOperation.ParentOperationId = operation.getAttribute('parentoperationcode');
    ...
    if (flag) {
        ...
        if (modules.length > 0) {
            ...
            message = "Rhe operation(s) <b>" + operations + " </b> cannot be assigned as their parent operation(s) are not selected.";
        }
