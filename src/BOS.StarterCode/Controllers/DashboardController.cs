...
namespace BOS.StarterCode.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public IActionResult NavigationMenu(string selectedModuleId)
        {
            try
            {
                //Checking for a valide Selected module Id
                if (selectedModuleId == null)
                {
                    throw new ArgumentNullException("The selected moduleId cannot be null");
                }
                ...
                if (model != null)
                {
                    model.CurrentModuleId = selectedModuleId; //Setting the current moduleId to, in this case, will always be a non-BOS, custom moduleId
                }
